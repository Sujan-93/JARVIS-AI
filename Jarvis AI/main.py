...
def ReadChatLogJson():
    try:
        with open(r"Data\ChatLog.json", "r", encoding="utf-8") as file:
            ...
            return json.loads(data)  # Load JSON properly
    except FileNotFoundError:
        print("⚠️ Warning: ChatLog.json not found. Creating a new one.")
        with open(r"Data\ChatLog.json", "w", encoding="utf-8") as file:
            json.dump([], file)  # Create an empty JSON array
        return []
    except json.JSONDecodeError:
        print("⚠️ Warning: ChatLog.json is corrupted. Resetting file.")
        with open(r"Data\ChatLog.json", "w", encoding="utf-8") as file:
            json.dump([], file)  # Reset JSON file
        return []
